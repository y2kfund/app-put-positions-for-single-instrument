...
function Ci(l, e) {
  const t = bi(), i = ui(), s = ["putPositions", l, e], n = ci({
    queryKey: s,
...
const jn = { class: "put-positions-for-single-instrument-view" }, Un = { class: "positions-header" }, $n = {
  key: 0,
    ...
    async function ti() {
      if (!(!e.symbolRoot || !e.userId)) {
        ...
        try {
          ...
          f.value = C.filter(
            (v) => v.asset_class === "OPT" && ii(v.symbol) && v.symbol.includes(" P ")
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, uo = /* @__PURE__ */ no(so, [["__scopeId", "data-v-82b96f8e"]]);
export {
  uo as default,
  uo as putPositions
};
