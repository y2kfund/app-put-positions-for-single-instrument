...
function Ri(l, e) {
  const t = Ci(), i = pi(), s = ["putPositions", l, e], n = mi({
    queryKey: s,
...
const qn = { class: "put-positions-for-single-instrument-view" }, Xn = { class: "positions-header" }, Jn = {
  key: 0,
  ...
  setup(l) {
    ...
    async function ri() {
      if (!(!e.symbolRoot || !e.userId)) {
        ...
        try {
          ...
          f.value = C.filter(
            (v) => v.asset_class === "OPT" && ai(v.symbol) && v.symbol.includes(" P ")
    ...
    return ci(async () => {
      ...
      return Q(), Y("div", qn, [
        U("div", Xn, [
          v[2] || (v[2] = U("h2", null, "Put Positions", -1)),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, po = /* @__PURE__ */ ao(ro, [["__scopeId", "data-v-f14aef39"]]);
export {
  po as default,
  po as putPositions
};
