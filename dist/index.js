...
function Ji(l, e) {
  const t = qi(), i = Vi(), s = ["putPositions", l, e], n = Ni({
    queryKey: s,
...
const yo = { class: "put-positions-for-single-instrument-view" }, Eo = { class: "positions-header" }, Ro = {
  key: 0,
  ...
  setup(l) {
    ...
    async function Li() {
      if (!(!e.symbolRoot || !e.userId)) {
        ...
        try {
          ...
          v.value = b.filter(
            (p) => p.asset_class === "OPT" && Di(p.symbol) && p.symbol.includes(" P ")
    ...
    return st(de, (b) => {
      ...
      return H(), F("div", yo, [
        k("div", Eo, [
          p[13] || (p[13] = k("h2", null, "Put Positions", -1)),
