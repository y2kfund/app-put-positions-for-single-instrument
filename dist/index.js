...
function is(l, e) {
  const t = Zi(), i = Ui(), s = ["putPositions", l, e], n = $i({
    queryKey: s,
...
const Mo = { class: "put-positions-for-single-instrument-view" }, Lo = { class: "positions-header" }, Do = {
  key: 0,
  ...
  setup(l) {
    ...
    async function Hi() {
      if (!(!e.symbolRoot || !e.userId)) {
        ...
        try {
          ...
          v.value = g.filter(
            (f) => f.asset_class === "OPT" && Pi(f.symbol) && f.symbol.includes(" P ")
    ...
    return rt(ce, (g) => {
      ...
      return _(), A("div", Mo, [
        T("div", Lo, [
          f[13] || (f[13] = T("h2", null, "Put Positions", -1)),
                  ...
                  (_(!0), A(je, null, Ue(Ne.value, (C) => (_(), A("div", {
                    ...
                    T("div", ur, [
                      ...
                      T("div", gr, [
                        ...
                        T("span", null, W(Bi(C.fetched_at)), 1)
                      ])
                    ])
                  ], 10, hr))), 128)),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Lr = /* @__PURE__ */ Er(yr, [["__scopeId", "data-v-52f18c7b"]]);
export {
  Lr as default,
  Lr as putPositions
};
