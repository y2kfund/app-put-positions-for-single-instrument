...
const ln = { class: "put-positions-for-single-instrument-view" }, hn = { class: "positions-header" }, dn = {
  key: 0,
  ...
  setup(l) {
    ...
    return Dt(() => {
      ...
      return te(), ee("div", ln, [
        J("div", hn, [
          d[0] || (d[0] = J("h2", null, "Put Positions", -1)),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, yn = /* @__PURE__ */ mn(pn, [["__scopeId", "data-v-779c4bfd"]]);
export {
  yn as default,
  yn as putPositions
};
