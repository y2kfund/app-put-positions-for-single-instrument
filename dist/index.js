...
function es(l, e) {
  const t = Yi(), i = Gi(), s = ["putPositions", l, e], n = ji({
    queryKey: s,
...
const To = { class: "put-positions-for-single-instrument-view" }, ko = { class: "positions-header" }, Mo = {
  key: 0,
  ...
  setup(l) {
    ...
    async function Fi() {
      if (!(!e.symbolRoot || !e.userId)) {
        ...
        try {
          ...
          v.value = g.filter(
            (p) => p.asset_class === "OPT" && Hi(p.symbol) && p.symbol.includes(" P ")
    ...
    return rt(ce, (g) => {
      ...
      return F(), z("div", To, [
        T("div", ko, [
          p[13] || (p[13] = T("h2", null, "Put Positions", -1)),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, kr = /* @__PURE__ */ Cr(wr, [["__scopeId", "data-v-5d39b70e"]]);
export {
  kr as default,
  kr as putPositions
};
