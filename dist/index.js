...
function Jt(l, e) {
  const t = Ut(), i = It(), s = ["putPositions", l, e], n = Nt({
    queryKey: s,
...
const bn = { class: "put-positions-for-single-instrument-view" }, vn = { class: "positions-header" }, wn = {
  key: 0,
  ...
  setup(l) {
    ...
    async function c() {
      if (!(!e.symbolRoot || !e.userId)) {
        ...
        try {
          ...
          n.value = C.filter(
            (w) => w.asset_class === "OPT" && u(w.symbol) && w.symbol.includes(" P ")
    ...
    return Vt(() => {
      ...
      return V(), B("div", bn, [
        H("div", vn, [
          w[2] || (w[2] = H("h2", null, "Put Positions", -1)),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, _n = /* @__PURE__ */ zn(Dn, [["__scopeId", "data-v-4cf3e42e"]]);
export {
  _n as default,
  _n as putPositions
};
